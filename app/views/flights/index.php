...
<table>
    <thead><tr>
        <th>Sıra</th><th>Kalkış</th><th>Varış</th><th>Kalkış Zamanı</th><th>Varış Zamanı</th><th>Uçak</th><th>Yolcular</th><th>Aksiyon</th>
    </tr></thead>
    <tbody>
    <?php $i=1; foreach ($flights as $f): ?>
        <tr>
            ...
            <td class="actions" style="display:flex; gap:6px;">
                ...
                <form method="post" action="<?= $BASE ?>/app/views/flights/index.php" onsubmit="return confirm('Uçuş silinsin mi?')">
